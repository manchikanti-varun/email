...
export function summarize(contacts) {
  ...
  for (const c of contacts) {
    ...
    // Prefer the structured risk signals; fall back to evidence labels.
  ...
  // role-based does NOT reduce data quality — it is a characteristic, not a
  // defect.
  ...
  // Overall health = average contact score, lightly weighted by risk mix.
